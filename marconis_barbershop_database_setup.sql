-- ========================================
-- MARCONI'S BARBERSHOP DATABASE SETUP
...
-- Step 3: Connect to the new database (this is handled outside the script in pgAdmin4)
-- Manually select the 'marconis_barbershop' database in pgAdmin4 before running the rest

-- Step 4: Create Schema and Set Privileges
...
-- Step 5: Create Enums (in correct order)
...
-- Step 6: Create Tables (following Prisma schema structure)
...
-- Step 9: Enable Row Level Security (Optional - for enhanced security)
-- ALTER TABLE "users" ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE "bookings" ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE "payments" ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE "messages" ENABLE ROW LEVEL SECURITY;

-- Step 10: Insert Initial Seed Data
...
-- Note: This is a bcrypt hash of "admin123" with 12 rounds
...
-- Step 11: Grant all privileges to app user
...
-- 
-- CONNECTION STRING:
-- postgresql://barber_app:BarbeR2024#SecurE@localhost:5432/marconis_barbershop
-- ========================================